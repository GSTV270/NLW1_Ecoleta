...
import { StyleSheet, View, Text, Image, SafeAreaView, Linking } from 'react-native';
...
const Detail: React.FC = () => {
  ...
  const handleWhatsapp = useCallback(() => {
    Linking
      .openURL(
        `whatsapp://send?phone=+55${data.whatsapp}&text=Tenho interesse sobre coleta de resíduos`
      );
  }, [data]);
